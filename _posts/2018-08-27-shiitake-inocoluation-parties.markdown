...
Folks are very welcome to join us and learn about inoculation and to take home some logs.
...
enjoying doing something optimistic together.
...
See this species selection table: https://www.fieldforest.net/pdfs/Tree%20Species%20Chart.pdf

It's important to use trees that have a great deal of stored food energy. It's this stored
food energy that the mushroom mycelium processes and uses to fruit mushrooms intermittently.
...
turned color in the Fall the tree is no longer making and storing more food energy. This is a great
...
After cutting the logs should be placed in low stacks off the ground and protected from
drying out excessively. If they end up stacked where it's sunny cover them with something
when it's not rainy to lessen the tendency to dry out.

Another good time to cut logs is in the early Spring before the buds swell. Around
here that usually means in March. As this point the tree still hasn't used much of the
...
Pohu Oysters mushrooms growing on an Aspen log.
...
After inoculation the logs will usually need a full growing season before the first fruiting.
Mycelium grows best when the weather is warmer and the logs stay relatively moist.
...
2. Once established if the log drys out the mycelium won't die -- it will just stop growing. You'll get mushrooms sooner if thelogs are kept relatively moist.
...
Shiitake mycelium will still grow throughout a log even if other fungi are also colonizing
...
It will be both easier to see and pick mushrooms that are fruiting when thelogs are in a
close to vertical lean.

I've started placing flat rocks around the trees I lean the logs on so the bottom of
the log is not in contact iwth the ground.
![standing logs on rocks]({{site.url}}/assets/images/mushrooms/standing-logs-on-rocks.jpg)

### Signs things are progressing properly in that first year.

The spawn we use for inoculating the trees is mixture of mycelium growing throughout a sawdust
medium. When we first put it into drilled holes in the logs and cover it with wax it appears
to be a light brown.

The color of the spawn under the wax will change from medium brown to white in about two weeks of
warm weather and sufficient moisture. The change to white is the first indication sign of
mycelium growing happiness.

After another four weeks of good mycelium groing conditions white mycelium growth spots
will appear at ends of the logs. The first spots will appear in the invcoluationholes closest
to that end. Most of the cells in a log are oriented longitudinally and this cell orientation
...
After a log has fruited for the first time you can force (encourage) a log to fruit by
exposing it to a temperature/moisture shock. Put the logs in a cold steam of a stock
tank filled with cold water for a day. Then take them out and lean them up. If the
mycelium was ready you will have a new fruiting ready to pick in a week.
...
I force my logs by throwing them into the cold stream next to where I keep them for a day.

### What can you expect the second and subsequent years?
...
Fall 2017 Kathy Becker brough Beech logs and Lions Mane in plug form. Reports are that initial growth
before firts fruiting takes two years.