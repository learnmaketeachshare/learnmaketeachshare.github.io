...
At Concord Consortium Charles Xie had also created a Java-based modeling system for 2D thermodynamics modeling called [Energy2D](http://energy.concord.org/energy2d/){:target="_blank"}. Energy2D models three modes of heat transmission: conduction, convection and a simple model of radiation.
...
![avalanche2d-js performanceimprovement](http://stepheneb.github.io/avalanche2d-js/images/avalanche2d-js-performance.png)
...
Two years later we had created an entire framework for modeling and visualization we called [The Lab Framework](http://lab.concord.org/){:target="_blank"}.
...
{% include iframe.html width="500px" height="405px" src="http://lab.concord.org/embeddable.html#interactives/samples/4-100-atoms-conceptual.json" %}
...
{% include iframe.html width="540px" height="400px" src="http://lab.concord.org/embeddable.html#interactives/visual/recycling/4-tireforces.json" %}
...
{% include iframe.html width="540px" height="400px" src="http://lab.concord.org/embeddable.html#interactives/visual/recycling/2-metalforces.json" %}
...
{% include iframe.html width="540px" height="400px" src="http://lab.concord.org/embeddable.html#interactives/visual/recycling/1-ceramicforces.json" %}
...
{% include iframe.html width="700px" height="500px" src="http://lab.concord.org/embeddable.html#interactives/inquiry-examples/pendulum/3-pendulum-simple-180.json" %}
...
JSON structure for the Interactive: [Charged and Neutral Atoms (conceptual version)](http://lab.concord.org/embeddable.html#interactives/samples/4-100-atoms-conceptual.json).

{% include iframe.html width="780px" height="400px" scrolling="true" src="http://lab.concord.org/interactives/samples/4-100-atoms-conceptual.json" %}

<div class="caption">  [lab.concord.org/interactives/samples/4-100-atoms-conceptual.json](http://lab.concord.org/interactives/samples/4-100-atoms-conceptual.json){:target="_blank"}
</div>
...
{% include iframe.html width="780px" height="400px" scrolling="true" src="http://lab.concord.org/models-converted/lab-version/1/md2d/conversion-and-physics-examples/100-atoms$0.json" %}

<div class="caption">  [lab.concord.org/models-converted/lab-version/1/md2d/conversion-and-physics-examples/100-atoms$0.json](http://lab.concord.org/models-converted/lab-version/1/md2d/conversion-and-physics-examples/100-atoms$0.json){:target="_blank"}
</div>
